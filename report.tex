...
\usepackage{boondox-cal} % Formal scripts
...
\begin{figure}[H]
    \centering
    \includegraphics{"report/rt81_suboptimal".png}
...
\begin{algorithm}[H]
    ...
    \begin{algorithmic}[1]
        ...
        \For{each vertex $v$}
            \State{Compute the force $f$ on $v$}
            \State{Move $v$ in the direction of $f$ by a small proportion to the magnitude of $f$}
        \EndFor
        \EndWhile
        \EndProcedure
    \end{algorithmic}
